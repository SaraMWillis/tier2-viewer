...
def usage(command):
    ...
    print('                                        : in it, either use quotes, e.g.: --prefix="file name.txt", or escape the special')
    print('                                        : character, e.g. --prefix=file\ name.')
    print("")
    ...
    print("  --size                                : Get the size of a file or directory in your bucket.")
    ...
    print("  --no-color                            : Turn off warning and directory colors.")
